 ...
 * @Descripttion:
 * @Author:
 * @Date: 2023-07-08 13:39:22
 * @LastEditTime: 2023-07-30 10:39:43
 */
package controllers
...
func Signup() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if inserterr != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "the use did not get created"})
		}
		defer cancel()
